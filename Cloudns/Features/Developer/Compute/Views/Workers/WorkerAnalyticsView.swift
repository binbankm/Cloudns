...
public struct WorkerAnalyticsView: View {
    ...
    public init(accountId: String, scriptName: String) {
        ...
        _viewModel = StateObject(
            wrappedValue: WorkerAnalyticsViewModel(accountId: accountId, scriptName: scriptName)
        )
    }
