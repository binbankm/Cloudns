...
final class SSLSettingsViewModel: BaseLoadableViewModel {
    ...
    func updateSSLMode(zoneId: String, mode: String) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("SSL/TLS Mode", message: "Updated to \(mode.capitalized)")
        } catch {
    ...
    func updateAlwaysUseHTTPS(zoneId: String, isOn: Bool) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("Always Use HTTPS", message: isOn ? "Enabled" : "Disabled")
        } catch {
    ...
    func updateAutomaticHTTPSRewrites(zoneId: String, isOn: Bool) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("HTTPS Rewrites", message: isOn ? "Enabled" : "Disabled")
        } catch {
    ...
    func updateMinTLSVersion(zoneId: String, version: String) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("Minimum TLS", message: "Set to TLS \(version)")
        } catch {
    ...
    func updateTLS13(zoneId: String, isOn: Bool) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("TLS 1.3", message: isOn ? "Enabled" : "Disabled")
        } catch {
            self.tls13 = previous
            self.errorMessage = error.localizedDescription
            CloudnsToastManager.shared.showError("Update Failed", message: error.localizedDescription)
    ...
    func updateOpportunisticEncryption(zoneId: String, isOn: Bool) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("Opportunistic Encryption", message: isOn ? "Enabled" : "Disabled")
        } catch {
    ...
    func updateOpportunisticOnion(zoneId: String, isOn: Bool) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("Opportunistic Onion", message: isOn ? "Enabled" : "Disabled")
        } catch {
    ...
    func updateHSTS(zoneId: String, enabled: Bool, maxAge: Int, subdomains: Bool, nosniff: Bool, preload: Bool = false) async {
        ...
        do {
            ...
            CloudnsToastManager.shared.showSuccess("HSTS Updated", message: enabled ? "HSTS is active." : "HSTS is disabled.")
        } catch {
            ...
            self.errorMessage = error.localizedDescription
            CloudnsToastManager.shared.showError("HSTS Update Failed", message: error.localizedDescription)
        }
    }
}
