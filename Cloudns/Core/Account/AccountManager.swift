...
final class AccountManager: ObservableObject {
    ...
    private init() {
        activeEmail = UserDefaults.standard.string(forKey: AppStorageKey.activeAccountEmail) ?? ""
        isLoggedIn = UserDefaults.standard.bool(forKey: AppStorageKey.isLoggedIn)
    ...
    func loadAccounts() {
        ...
        accountEmails = Array(allAccounts.keys).sorted()
    ...
    func getAPIKey(for email: String) -> String? {
        KeychainHelper.standard.readString(service: serviceName, account: email)
    }
